...
class LaransiController extends Controller
{
    ...
    public function detailNeracaLajur(Request $request, $waktu)
    {
        ...
        return view('benadventure.neraca-lajur.neraca-lajur-detail', compact('data2', 'total_saldo_debetpenyesuaian', 'total_saldo_kreditpenyesuaian', 'total_saldo_debet', 'total_saldo_kredit', 'periode'));
    }
