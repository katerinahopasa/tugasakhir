            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
              ...
              <li class="nav-item has-treeview menu-open">
                ...
                <ul class="nav nav-treeview">
                  ...
                  <li class="nav-item">
                    <a href="{{ url('manajer/laporan') }}" class="nav-link active">
                      <i class="nav-icon far fa-image"></i>
                      <p>
                        Laporan
                      </p>
        ...
        <div class="card">
        	<div class="container main">
                ...
                @endif
                  ...
                  {!! Form::open(['url' => 'manajer/laporan/cari', 'method' => 'get', 'class' => 'form-inline text-center']) !!}
                  <div class="col-md-3">
                  ...
                  {!! Form::close() !!}
                    <br>
                        ...
                        <h6>Total Data : <strong>{{ $total_jurnal }}</strong> </h6>
                        ...
                        <caption class="text-center"> <strong>DAFTAR LAPORAN</strong></caption>
                          ...
                          <tr>
                            ...
                            <td>
                             ...
                             @endif
                              <a href="{{ url('laporan/cetak/'.date('Y-m-d', strtotime('1-'.$data->waktu))) }}" href="manajer/laporan/cetakLaporan" class="btn btn-info">
                                Cetak
                              </a>
                            </td>
                          </tr>
