...
<!-- /.content-header -->
  <div class="col-md-12">
    <div class="card card-default">
       <div class="card-header" align=center><strong>TAMBAH DATA JENIS TRANSAKSI</strong>
       </div>
       <!-- /.card-header -->
       <!-- form start -->
       <form action="{{ route('tambahJenisTransaksi') }}" method="POST" enctype="multipart/form-data">
         {{csrf_field()}}
          <div class="card-body">
            <div class="form-group row">
              <label class="col-sm-3 col-form-label">Nama Jenis Transaksi</label>
                <div class="col-sm-9">
                  <input name="nama_jenis" type="text" class="form-control" id="nama_jenis" aria-describedby="textHelp" placeholder="Masukan Nama Jenis Transaksi">
                 </div>
               </div>
               <div class="form-group row">
                 <label class="col-sm-3 col-form-label">Deskripsi</label>
                  <div class="col-sm-9">
                   <input name="deskripsi" type="text" class="form-control" id="deskripsi" aria-describedby="textHelp" placeholder="Masukan Deskripsi Jenis Transaksi">
                  </div>
                </div>
                  <div id="app">
                    @yield('content')
