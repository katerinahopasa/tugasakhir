                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9">
                          <select name="tipe" class="form-control">
                            ...
                            <option value="k">Pendapatan</option>
                            <option value="k">Beban</option>
                            <option value="k">Beban Penyusutan</option>
                            <option value="k">Peralatan/Perlengkapan</option>
                            <option value="k">Piutang</option>
                            <option value="k">Hutang</option>
                            <option value="k">Modal</option>
                            <option value="k">Akumulasi Penyusutan</option>
                            <option value="k">Kewajiban</option>
                            <option value="k">Biaya</option>
                            <option value="k">Ikhtisar</option>
                            <option value="k">Aktiva Tetap</option>
                            <option value="k">Lainnya</option>
                          </select>
                          {!! Form::text('jenis_akun', null, ['class' => 'form-control']) !!}
                        </div>
                      </div>
