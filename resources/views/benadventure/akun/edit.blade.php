					  ...
					  <div class="panel panel-default">
						  <div class="card-header">
      						...
      						<div class="card-body">
      							...
      							{!! Form::open(['url' => 'akun/'.$akun->id, 'method' => 'patch', 'class' => 'form-horizontal']) !!}
      							{{ csrf_field() }}
                    {{ method_field('PATCH') }}
      						    ...
      						    {!! Form::hidden('id', $akun->id) !!}
      								...
      								<div class="form-group">
      									...
      									<div class="col-md-9">
      										{!! Form::text('kode_akun', $akun->kode_akun, ['class' => 'form-control']) !!}
      									</div>
      								</div>
      								...
      								<div class="form-group">
      									...
      									<div class="col-md-9">
      										{!! Form::text('nama_akun', $akun->nama_akun, ['class' => 'form-control']) !!}
      									</div>
      								</div>
                     ...
                     <label class="col-md-3 control-label" for="name">Jenis Akun</label>
                        <div class="col-md-9">
                       {!! Form::select('jenis_akun', ['aktiva_lancar' => 'Aktiva Lancar', 'pendapatan' => 'Pendapatan', 'beban' => 'Beban', 'modal' => 'Modal', 'ikhtisar' => 'Ikhtisar', 'aktiva_tetap' => 'Aktiva Tetap', 'pasiva' => 'Pasiva', 'ekuitas' => 'Ekuitas'], $akun->jenis_akun, ['class' => 'form-control', 'placeholder' => '-- Jenis Akun --']) !!}
                       </div>
                     </div>
