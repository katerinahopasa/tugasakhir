 ...
 <section class="content">
   <div class="row">
       ...
       <div class="card">
              ...
              {!! Form::open(['url' => 'jurnal/'.$jurnal->id, 'method' => 'patch', 'class' => 'form-horizontal']) !!}
                ...
                <div class="form-group">
                     <label class="col-md-3 control-label" for="name">Jenis Jurnal</label>
                       ...
                       {!! Form::select('jenis_jurnal', ['u' => 'Jurnal Umum', 'p' => 'Jurnal Penyesuaian'], $jurnal->jenis_jurnal, ['class' => 'form-control', 'placeholder' => '-- Jenis Jurnal --']) !!}
                       </div>
                     </div>
