          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-header">LAPORAN TATA BUKU</li>
             ...
             <li class="nav-item">
              ...
              <li class="nav-item">
               <a href="{{ url('nssd') }}" class="nav-link active">
                 <i class="far fa-circle nav-icon"></i>
                 <p>NSSD</p>
               </a>
              </li>
       ...
       <div class="col-md-12">
        <div class="card">
              ...
              @endif
                    ...
                    <h6 class="text-center"> <strong>DAFTAR NERACA</strong> </h6> 
      				    </div>
                  <div class="card-body">
      					   <div class="panel-body">

              <!-- {!! Form::open(['url' => 'nssd/cari', 'method' => 'get', 'class' => 'form-inline text-center']) !!}
              <div class="col-md-3">
              ...
              {!! Form::close() !!} -->
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                              <a href="{{ url('nssd/detail/'.date('Y-m-d', strtotime('1-'.$data->waktu))) }}" class="btn btn-info">
                                Detail
                              </a>
                              <!-- <a href="{{ url('cetak-nssd/'.date('Y-m-d', strtotime('1-'.$data->waktu))) }}" class="btn btn-warning">
                                Cetak
                              </a> -->
                            </td>
                          </tr>
