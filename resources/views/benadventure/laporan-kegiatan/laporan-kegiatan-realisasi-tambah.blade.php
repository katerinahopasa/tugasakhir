    ...
    <div class="card">
				<div class="panel panel-default">
					...
					<span class="pull-right clickable panel-toggle panel-button-tab-left"><em class="fa fa-toggle-up"></em></span></div>
		  			<div class="card-body">
					      ...
					      {!! Form::open(array('method'=>'POST','route' => ['lapkeg.store', $data->id], 'class'=>'form-horizontal')) !!}
							<div class="form-group">
						    {{ csrf_field() }}
								<label class="col-md-3 control-label" for="name">Pilih Kegiatan</label>
                  <div class="col-md-9">
                    {!! Form::select('id_laporankegiatan', $daftar_laporankegiatan, null, ['class' => 'form-control', 'placeholder' => '-- Daftar Nama Pelanggan Kegiatan --']) !!}
                  </div>
								</div>
              ...
              <div class="form-group">
                 <label class="col-md-3 control-label" for="name">Jenis Transaksi</label>
                  <div class="col-md-9">
                   {!! Form::select('id_jenis', $jenis_transaksikegiatan, null, ['class' => 'form-control', 'placeholder' => '-- Daftar Jenis Transaksi Kegiatan --']) !!}
                 </div>
                </div>
