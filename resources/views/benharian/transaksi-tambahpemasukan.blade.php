...
<div class="content-wrapper" style="min-height: 1196.05px;">
    ...
    <div class="col-md-12">
        <div class="card card-default">
           <div class="card-header" align=center><strong>TAMBAH PEMASUKAN HARIAN</strong>
            </div>
              <!-- /.card-header -->
              <!-- form start -->
             <form action="{{ route('tambahPemasukan') }}" method="POST" enctype="multipart/form-data">
              {{csrf_field()}}
              <div class="perhitungan">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <input name="jml_pengunjung" type="number" class="form-control" id="jml_pengunjung" aria-describedby="textHelp" placeholder="Masukan Jumlah Pengunjung">
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                   <input name="harga_tiket" type="number" class="form-control" id="harga_tiket" aria-describedby="textHelp" placeholder="Masukan Harga Tiket">
                  </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input name="total_pemasukan" type="text" class="form-control" id="total" aria-describedby="textHelp" placeholder="Total" readonly="readonly">
                    </div>
                </div>
                ...
                <div class="form-group row">
                   ...
                   <div class="col-sm-10">
                     <input name="keterangan" type="text" class="form-control" id="keterangan" aria-describedby="textHelp" placeholder="">
                   </div>
                </div>
                      <div id="app">
                          @yield('content')
